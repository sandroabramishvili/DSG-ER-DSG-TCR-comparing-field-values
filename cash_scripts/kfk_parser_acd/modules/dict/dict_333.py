...
msgids = {
	...
	'12070': 'IAMilestone',
	'12071': 'IAMarketMakerAlert',
	'12073': 'IAShortOrderVenueChange',
	'12077': 'IAShortOrderSweep',
	'12050': 'IAQuote',
	'12051': 'IAAFQRFE',
	'12052': 'IAPriceInput',
	...
	'12249': 'IAInstrumentClassification',
	'12250': 'IANotice',
	'12251': 'IAUnderlying',
	...
	'12256': 'IACouponDate',
	'12257': 'IAMemberRegistrationRole',
	'12234': 'IATradeClearing',
	'12240': 'IAIndexLevel',
	'12241': 'IAIndexReferential',
	'12258': 'IATradeClearingFilter'
}
...
msgs['RG_12005_IOFO'] = [
	...
	['orderPx', '8', 'Int64'],
	['orderQty', '8', 'UInt64'],
	['parentStrategySymbolIndex', '4', 'UInt32']
]
...
msgs['IAMilestone'] = [
	['produceTime', '8', 'UInt64'],
	['consumeTime', '8', 'UInt64'],
	['milestoneType', '1', 'UInt8'],
	['applicationID', '1', 'UInt8'],
	['mIC', '4', 'Char']
]

msgs['IAMarketMakerAlert'] = [
	['produceTime', '8', 'UInt64'],
	['consumeTime', '8', 'UInt64'],
	['sequenceTime', '8', 'UInt64'],
	['eventID', '8', 'UInt64'],
	...
	['symbolIndex', '4', 'UInt32'],
	['alertTime', '8', 'UInt64'],
	['marketMakerAlertCode', '1', 'UInt8'],
	['instrumentState', '1', 'UInt8'],
	['bookState', '1', 'UInt8'],
	['derivativesInstrumentType', '1', 'UInt8'],
	['maturityDate', '8', 'Char'],
	['numberOfStrikes', '4', 'UInt32']
]

msgs['IAShortOrderVenueChange'] = [
	['produceTime', '8', 'UInt64'],
	['consumeTime', '8', 'UInt64'],
	['symbolIndex', '4', 'UInt32'],
	['eMM', '1', 'UInt8'],
...
msgs['RG_12050_BQ'] = [
	...
	['bidPreviousSize', '8', 'UInt64'],
	['bidPreviousPx', '8', 'Int64']
]
...
msgs['RG_12050_OQ'] = [
	...
	['offerPreviousSize', '8', 'UInt64'],
	['offerPreviousPx', '8', 'Int64']
]
...
msgs['IACurrency'] = [
	...
	['yearlyECBRate', '8', 'UInt64'],
	['yearlyECBRateDate', '2', 'UInt16']
]
...
msgs['IAParticipantCashAuthor'] = [
	...
	['marketPlace', '3', 'Char'],
	['batchID', '1', 'UInt8'],
	['algorithmIndicator', '1', 'UInt8'],
	['dMAIndicator', '1', 'UInt8'],
	['coLocationIndicator', '1', 'UInt8']
]
...
msgs['IAInstrument'] = [
	...
	['poolFactor', '4', 'UInt32'],
	['purgeBookType', '1', 'UInt8'],
	['applicantName', '60', 'Char'],
	['exerciseDateFrom', '2', 'UInt16'],
	['exerciseDateTo', '2', 'UInt16'],
	['conversionDateFrom', '2', 'UInt16'],
	['conversionDateTo', '2', 'UInt16'],
	['suspensionOriginLabel', '150', 'Char'],
	['detachedCouponNumber', '2', 'UInt16'],
	['settlementDate', '2', 'UInt16'],
	['currentCouponNumber', '2', 'UInt16'],
	['parentSymbolIndex', '4', 'UInt32'],
	['subordinateMarket', '1', 'UInt8'],
	['operationStartDate', '2', 'UInt16'],
	['operationEndDate', '2', 'UInt16'],
	['cumulativeQuantityNotificationIndicator', '1', 'UInt8'],
	['tradeParkingIndicator', '1', 'UInt8'],
	['allocationAlgorithm', '2', 'UInt16'],
	['sideAuthorization', '1', 'UInt8'],
	['maxNbrSecuritiesOfferedOrTendered', '8', 'UInt64'],
	['tradeEndValidityDate', '2', 'UInt16'],
	['tradeEndValidityDays', '1', 'UInt8'],
	['eSGProductClassification', '1', 'UInt8'],
	['lastPublicNAVValue', '8', 'Int64'],
	['lastPublicNAVValueDate', '2', 'UInt16'],
	['professionalTrading', '1', 'UInt8'],
	['underlyingID', '8', 'UInt64'],
	['benchmarkStyle', '1', 'UInt8'],
	['benchmarkArea', '100', 'Char'],
	['investmentStrategy', '1', 'UInt8'],
	['tradingAnchoredToNAVIndicator', '1', 'UInt8'],
	['redemptionPrice', '8', 'Int64'],
	['dayCountConvention', '1', 'UInt8'],
	['instrumentClassType', '1', 'UInt8'],
	['adjustmentFactorDecimals', '1', 'UInt8'],
	['couponIndexReferenceName', '80', 'Char'],
	['issueDate', '2', 'UInt16'],
	['minimumSettlementAmount', '8', 'UInt64'],
	['interestRateOrigin', '1', 'UInt8'],
	['earlyRedemptionType', '1', 'UInt8'],
	['interestPaymentDateAdjustableFlag', '1', 'UInt8'],
	['placeOfSafekeeping', '11', 'Char'],
	['issuanceCountryCode', '3', 'Char'],
	['issuanceLawCountryCode', '3', 'Char'],
	['commercialInstrumentName', '100', 'Char'],
	['quantoFlag', '1', 'UInt8'],
	['participationPercentage', '8', 'UInt64'],
	['certificateBonusLevel', '8', 'UInt64'],
	['certificateBonusLevelExpressionType', '1', 'UInt8'],
	['commissionsPercentage', '4', 'UInt32'],
	['capValue', '8', 'UInt64'],
	['capValueExpressionType', '1', 'UInt8'],
	['floorValue', '8', 'UInt64'],
	['floorValueExpressionType', '1', 'UInt8'],
	['barrierCapitalObservation', '1', 'UInt8'],
	['autocallObservation', '1', 'UInt8'],
	['leverageAmount', '8', 'UInt64'],
	['restrikeValue', '8', 'Int64'],
	['restrikeValueExpressionType', '1', 'UInt8'],
	['barrierCapitalValue', '8', 'UInt64'],
	['barrierCapitalValueExpressionType', '1', 'UInt8'],
	['barrierCouponValue', '8', 'UInt64'],
	['barrierCouponValueExpressionType', '1', 'UInt8'],
	['barrierAutocallValue', '8', 'UInt64'],
	['barrierAutocallValueExpressionType', '1', 'UInt8'],
	['payoffAlteringBarrierValue', '8', 'UInt64'],
	['payoffAlteringBarrierValueExpressionType', '1', 'UInt8'],
	['lowerBarrier', '8', 'UInt64'],
	['upperBarrier', '8', 'UInt64'],
	['settlementPeriod', '1', 'UInt8'],
	['maximumGlobalNominalAmount', '8', 'UInt64'],
	['continuousToCallTransitionDate', '2', 'UInt16'],
	['iPOPatternType', '1', 'UInt8'],
	['minimumDistributionAmount', '8', 'UInt64'],
	['maximumDistributionAmount', '8', 'UInt64'],
	['businessDayConvention', '1', 'UInt8'],
	['couponStartAccrualDate', '2', 'UInt16'],
	['couponType', '1', 'UInt8'],
	['firstCouponPaymentDate', '2', 'UInt16'],
	['couponRate', '4', 'UInt32'],
	['issuePriceCurrency', '3', 'Char'],
	['totalIssuedAmount', '8', 'UInt64'],
	['applicableTaxLawCountryCode', '3', 'Char'],
	['redemptionFrequency', '1', 'UInt8'],
	['parityInstrumentPerUnderlying', '8', 'UInt64'],
	['marketingProductNameID', '4', 'UInt32'],
	['maximumInvestorAllocatedQuantity', '8', 'UInt64'],
	['buyBackIndicator', '1', 'UInt8'],
	['leverageLevel', '8', 'Int64'],
	['maxOrderQuantityCallSource', '1', 'UInt8'],
...
msgs['RG_12224_EMMPR'] = [
	...
	['lotSize', '8', 'UInt64'],
	['instUnitExp', '1', 'UInt8'],
	['orderEntryModel', '1', 'UInt8']
]

msgs['RG_12224_BR'] = [
	['basisofAccrualsCalculation', '1', 'UInt8'],
	['linkedISIN', '12', 'Char'],
	['linkedMIC', '4', 'Char'],
	['linkedCurrency', '3', 'Char']
]

msgs['RG_12224_SPR'] = [
	['protectionLevelValue', '8', 'UInt64'],
	['protectionLevelValueExpressionType', '1', 'UInt8'],
	['initialValue', '8', 'UInt64'],
	['initialValueExpressionType', '1', 'UInt8'],
	['priceEventValue', '8', 'Int64'],
	['priceEventValueExpressionType', '1', 'UInt8'],
	['strikeDate', '2', 'UInt16'],
	['finalValuationDate', '2', 'UInt16'],
	['kIBIProduct', '1', 'UInt8'],
	['kOBIProduct', '1', 'UInt8'],
	['lastTradingDate', '2', 'UInt16'],
	['timeClosing', '8', 'UInt64'],
	['distributionType', '1', 'UInt8']
]
...
msgs['IAMarketMakerObligations'] = [
	...
	['spreadMaximumValueDecimals', '1', 'UInt8'],
	['lPMonitoredPeriod', '1', 'UInt8'],
	['lPComparableSizeUnitExpression', '1', 'Char'],
	['lPSMCRelaxedObligationsIndicator', '1', 'UInt8'],
	['spreadMaximumID', '2', 'UInt16']
]
...
msgs['IAIssuer'] = [
	...
	['issuerGroupName', '60', 'Char'],
	['issuerLegalCountry', '3', 'Char'],
	['issuerNDGCode', '4', 'UInt32'],
	['issuerListedCompanyPrimMkt', '1', 'UInt8'],
	['issuerType', '1', 'UInt8'],
	['miFIDIssuerType', '1', 'UInt8'],
	['issuerVATCode', '11', 'Char']
]
...
msgs['RG_12233_TGEMMP'] = [
	...
	['offerOnlyAuthorizationIndicator', '1', 'UInt8'],
	['eligibleForMonitoringIndicator', '1', 'UInt8'],
	['reopeningMode', '1', 'UInt8']
]

msgs['IAInstrumentClassification'] = [
	['produceTime', '8', 'UInt64'],
	['consumeTime', '8', 'UInt64'],
	['batchID', '1', 'UInt8'],
	['marketingProductNameID', '4', 'UInt32'],
	['marketingProductNameLabel', '40', 'Char'],
	['productSubtypeEnglishLabel', '70', 'Char'],
	['instrumentTypeID', '4', 'UInt32'],
	['instrumentTypeLabel', '50', 'Char'],
	['instrumentSubtypeID', '4', 'UInt32'],
	['instrumentSubtypeLabel', '50', 'Char'],
	['aCEPIType', '1', 'UInt8'],
	['aCEPIClass', '1', 'UInt8'],
	['callPutIndicator', '1', 'UInt8'],
	['bullBearIndicator', '1', 'UInt8']
]
...
msgs['IANotice'] = [
	...
	['instrumentID', '8', 'UInt64'],
	['symbolIndex', '4', 'UInt32'],
	['noteInTheOfficialListITA', '1000', 'Char'],
	['noteInTheOfficialListENG', '1000', 'Char']
]
...
msgs['IAUnderlying'] = [
	...
	['batchID', '1', 'UInt8'],
	['iSINCode', '12', 'Char'],
	['reutersRICCode', '24', 'Char'],
	['pseudoCode', '40', 'Char'],
	['cFICode', '6', 'Char'],
	['underlyingID', '8', 'UInt64'],
	['underlyingMnemonic', '6', 'Char'],
	['underlyingName', '102', 'Char'],
	['underlyingTypeName', '40', 'Char'],
	['underlyingSubtypeName', '70', 'Char'],
	['underlyingCountryCode', '3', 'Char'],
	['underlyingIssuerLEICode', '20', 'Char'],
	['underlyingBenchmarkArea', '100', 'Char'],
	['depositaryReceiptISINCode', '12', 'Char'],
	['parentInstrumentID', '8', 'UInt64'],
	['underlyingCurrency', '3', 'Char'],
	['bloombergTickerCode', '13', 'Char'],
	['underlyingIndexTerm', '8', 'Char'],
	['underlyingMICCode', '4', 'Char']
]
...
msgs['RG_12252_IACR'] = [
	['constituentInstrumentID', '8', 'UInt64']
]
...
msgs['IADayOff'] = [
	...
	['batchID', '1', 'UInt8'],
	['dayOff', '2', 'UInt16'],
	['calendarValueType', '1', 'UInt8'],
	['calendarValue', '50', 'Char']
]

msgs['IABondAmortizationSchedule'] = [
	['produceTime', '8', 'UInt64'],
	['consumeTime', '8', 'UInt64'],
	['batchID', '1', 'UInt8'],
	['symbolIndex', '4', 'UInt32'],
...
msgs['RG_12255_BASR'] = [
	['redemptionPrice', '8', 'Int64'],
	['redemptionDate', '2', 'UInt16'],
	['amortizingQuote', '8', 'Int64'],
	['currentQuote', '8', 'Int64'],
	['poolFactor', '4', 'UInt32'],
	['exDatePoolFactor', '2', 'UInt16']
]
...
msgs['RG_12256_CDS'] = [
	...
	['couponDate', '2', 'UInt16'],
	['exDate', '2', 'UInt16'],
	['paymentDate', '2', 'UInt16'],
	['recordDate', '2', 'UInt16'],
	['couponValue', '8', 'UInt64'],
	['periodicRate', '4', 'UInt32'],
	['annualRate', '4', 'UInt32'],
	['couponCapValue', '8', 'UInt64'],
	['couponFloorValue', '8', 'UInt64'],
	['observationDate', '2', 'UInt16'],
	['structuredProductCouponQualifier', '1', 'UInt8']
]

msgs['IAMemberRegistrationRole'] = [
	['produceTime', '8', 'UInt64'],
	['consumeTime', '8', 'UInt64'],
	['batchID', '1', 'UInt8'],
	['firmID', '8', 'Char'],
	['firmName', '100', 'Char'],
	['membershipSegmentID', '4', 'UInt32'],
	['membershipSegmentName', '50', 'Char'],
	['registrationRole', '3', 'Char'],
	['marketConsolidated', '2', 'UInt16'],
	['subscriptionID', '3', 'Char']
]
...
msgs['IATradeClearingFilter'] = [
	['produceTime', '8', 'UInt64'],
	['consumeTime', '8', 'UInt64'],
	['batchID', '1', 'UInt8'],
	['mIC', '4', 'Char'],
	['firmIDBuy', '8', 'Char'],
	['tradingCapacityBuy', '1', 'UInt8'],
	['firmIDSell', '8', 'Char'],
	['tradingCapacitySell', '1', 'UInt8'],
	['settlementSystem', '1', 'UInt8']
]
